...
public class UserService {
    ...
    public Boolean updateUser(Long userId, String userName, String userPassword, String firstName, String lastName, String phoneNumber)
    {
        ...
        if(user!=null)
        {
            ...
            Customer customer = customerRepository.getCustomerById(user.getCustomerId());
            if( customer!=null) {
                customer.setFirstName(firstName);
                customer.setLastName(lastName);
                customer.setPhoneNumber(phoneNumber);
                customerRepository.updateCustomer(customer, customer.getCustomerId());
            }
